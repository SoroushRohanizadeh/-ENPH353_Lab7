...
if __name__ == '__main__':
    ...
    obs_size = 4 #TO DO: Set observation size space
    n_actions = 2 #TO DO: Set action size space

    # Create the fNN object
